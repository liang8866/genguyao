...
int lua_cocos2dx_ui_Button_getSpriteChildren(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Button* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Button_getSpriteChildren'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Button_getSpriteChildren'", nullptr);
            return 0;
        }
        cocos2d::Vector<cocos2d::Node *> ret = cobj->getSpriteChildren();
        ccvector_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Button:getSpriteChildren",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Button_getSpriteChildren'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Button(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Button");
        ...
        tolua_function(tolua_S,"getSpriteChildren",lua_cocos2dx_ui_Button_getSpriteChildren);
...
int lua_cocos2dx_ui_RichText_xxgetRichSize(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichText_xxgetRichSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichText_xxgetRichSize'", nullptr);
            return 0;
        }
        cocos2d::Size ret = cobj->xxgetRichSize();
        size_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichText:xxgetRichSize",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichText_xxgetRichSize'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_RichText(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichText");
        ...
        tolua_function(tolua_S,"xxgetRichSize",lua_cocos2dx_ui_RichText_xxgetRichSize);
...
int lua_cocos2dx_ui_Scale9Sprite_getSpriteChildren(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Scale9Sprite* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Scale9Sprite_getSpriteChildren'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Scale9Sprite_getSpriteChildren'", nullptr);
            return 0;
        }
        cocos2d::Vector<cocos2d::Node *> ret = cobj->getSpriteChildren();
        ccvector_to_luaval(tolua_S, ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Scale9Sprite:getSpriteChildren",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Scale9Sprite_getSpriteChildren'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Scale9Sprite(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Scale9Sprite");
        ...
        tolua_function(tolua_S,"getSpriteChildren",lua_cocos2dx_ui_Scale9Sprite_getSpriteChildren);
